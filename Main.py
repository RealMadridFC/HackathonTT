...
while zz == 'y':
    ...
    if ch1 == 1:
        ...
        while c == 'y':
            ...
            if ch2 == 1:
                ...
                if 140 < BlP_Lu < 125:
                    ...
                    print(
                        "SUGGESTED : 1. REDUCE SALT IN DIET,2.GET GOOD 8 HOURS SLEEP,3.REDUCE STRESS,4. REDUCE WEIGHT")
                elif 75 > Hrt_L > 128:
        ...
        if a == 2:
            print(
                "The harsh truth is that Teens tend to eat more and more junk rather healthy food.\nThis can lead to high risk of health issues.")
            print(
